...
model = keras.models.load_model("./model/00058-0.004371-0.033815-0.066112-0.001079-0.027155-0.032850.h5")
...
plt.text(2.1, 6.8, "b", fontsize=26)
plt.xlim(1.9, 7.1)
plt.ylim(1.9, 7.1)
...
def plot_curve(true_data, predicted_data):
	...
	plt.text(1.0, 6.8, "b", fontsize=26)
	plt.ylim(1.9, 7.1)
