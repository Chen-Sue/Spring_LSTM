...
model = keras.models.load_model("./model/model_00225-0.003387-0.031655-0.058198-0.001014-0.025430-0.031842.h5")
...
plt.xlabel("Value of Spring discharge diffrence", fontsize=22)
...
plt.text(2.1, 6.8, "a", fontsize=26)
plt.xlim(1.9, 7.1)
plt.ylim(1.9, 7.1)
...
def plot_curve(true_data, predicted_data):
	...
	plt.rcParams['xtick.direction'] = 'out'
	plt.rcParams['ytick.direction'] = 'out'
	# plt.tick_params(axis="both", which="major", labelsize=13, top="on", bottom="on", left="on", right="on")
	...
	plt.text(1.0, 6.8, "a", fontsize=26)
	plt.ylim(1.9, 7.1)
	plt.yticks(fontsize=20)
